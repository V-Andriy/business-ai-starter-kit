...
flowchart TD
  ...
  LiveHandoff --> CodexLearner["Optional Codex-Learner orientation"]
  CodexLearner --> Calibrate["Ask user name, assistant name, style, detail level, and sources"]
  Calibrate --> DossierPreview["Inspect sources and show dossier preview"]
