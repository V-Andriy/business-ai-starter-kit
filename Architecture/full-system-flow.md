...
flowchart TD
  ...
  ReadInstalled --> BusinessSetup["Run Business-Setup onboarding"]
  BusinessSetup --> WorkspaceState["Fill dossiers, memory, active threads, focus, map, decisions, agent state"]
